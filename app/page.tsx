  ...
  return (
    <div className="min-h-screen font-oscine" style={{ background: "linear-gradient(to bottom, #8dbf4410, white)" }}>
      <main>
        ...
        <header className="bg-white shadow-sm border-b">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Image
                src="/atendja.png"
                alt="Atend Já Logo - Ultrassom em Feira de Santana"
                width={120}
                height={40}
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative flex justify-end">
                <Image
                  ...
                  alt="Equipamento de ultrassom moderno - Atend Já Feira de Santana"
                  width={500}
                  height={400}
        ...
        {/* Tipos de Ultrassom */}
        <section className="py-16 bg-white" id="exames" aria-labelledby="exames-titulo">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 id="exames-titulo" className="text-3xl md:text-4xl font-bold mb-4" style={{ color: "#3b3f3d" }}>
